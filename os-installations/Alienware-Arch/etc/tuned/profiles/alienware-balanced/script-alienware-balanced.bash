#!/bin/env bash
#
# alienware-balanced: profile script.
#
...
apply_power_policy() {
    ...
    ## MMIO
    echo 160000000 > "$RAPL_MMIO/constraint_2_power_limit_uw"
    echo 86000000 > "$RAPL_MMIO/constraint_1_power_limit_uw"
    echo 55000000 > "$RAPL_MMIO/constraint_0_power_limit_uw"
    echo 64000000 > "$RAPL_MMIO/constraint_0_time_window_us"

    ## MSR
    echo 160000000 > "$RAPL_MSR/constraint_2_power_limit_uw"
    echo 86000000 > "$RAPL_MSR/constraint_1_power_limit_uw"
    echo 55000000 > "$RAPL_MSR/constraint_0_power_limit_uw"
    echo 64000000 > "$RAPL_MSR/constraint_0_time_window_us"
}
