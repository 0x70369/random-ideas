...
Set-RegistryKey "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\FlyoutMenuSettings" "ShowHibernateOption" "REG_DWORD" "0"
...
Set-RegistryKey "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Session Manager\Power" "HibernateEnabled" "REG_DWORD" "0"

Write-Host "--------------------------------------"

Write-Host "Disabling hibernation... "
Start-Process -FilePath "C:\Windows\System32\powercfg.exe" -ArgumentList "/hibernate off" -NoNewWindow -Wait
